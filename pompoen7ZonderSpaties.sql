...
INSERT INTO `automatisch` (`ID`, `tijd`, `ventilator1`, `ventilator2`, `raam1`, `raam2`, `deur1`, `deur2`, `vat1`, `vat2`, `vat3`, `licht`) VALUES
...
CREATE TABLE `gewicht` (
  `ID` int NOT NULL,
  `tijd` datetime NOT NULL,
  `gewichtp1` int NOT NULL,
  `gewichtp2` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `pompoen1` (`ID`, `tijd`, `temperatuur`, `grondvochtigheidlaag1`, `grondvochtigheidlaag2`) VALUES
...
INSERT INTO `pompoen2` (`ID`, `tijd`, `temperatuur`, `grondvochtigheidlaag1`, `grondvochtigheidlaag2`) VALUES
...
INSERT INTO `serre` (`ID`, `tijd`, `deur1`, `deur2`, `raam1`, `raam2`, `lichtsterkte`, `co2`, `luchtvochtigheid`) VALUES
...
CREATE TABLE `threshold` (
  `ID` int NOT NULL,
  `tijd` datetime NOT NULL,
  `tempventilator1` int NOT NULL,
  `tempventilator2` int NOT NULL,
  `tempraam1` int NOT NULL,
  `tempraam2` int NOT NULL,
  `tempdeur1` int NOT NULL,
  `tempdeur2` int NOT NULL,
  `minvat1` int NOT NULL,
  `maxvat1` int NOT NULL,
  `minvat2` int NOT NULL,
  `maxvat2` int NOT NULL,
  `minvat3` int NOT NULL,
  `maxvat3` int NOT NULL,
  `grondvochtigheid1laag1` int NOT NULL,
  `grondvochtigheid1laag2` int NOT NULL,
  `grondvochtigheid2laag1` int NOT NULL,
  `grondvochtigheid2laag2` int NOT NULL,
  `licht` int NOT NULL,
...
INSERT INTO `threshold` (`ID`, `tijd`, `tempventilator1`, `tempventilator2`, `tempraam1`, `tempraam2`, `tempdeur1`, `tempdeur2`, `minvat1`, `maxvat1`, `minvat2`, `maxvat2`, `minvat3`, `maxvat3`, `grondvochtigheid1laag1`, `grondvochtigheid1laag2`, `grondvochtigheid2laag1`, `grondvochtigheid2laag2`, `licht`, `lichtkleur`) VALUES
...
CREATE TABLE `water` (
  ...
  `vat2` int NOT NULL,
  `vat3` int NOT NULL,
  `in_vat1` tinyint(1) NOT NULL,
  `in_vat2` tinyint(1) NOT NULL,
  `uit_vat1.1` tinyint(1) NOT NULL,
  `uit_vat1.2` tinyint(1) NOT NULL,
  `uit_vat2.1` tinyint(1) NOT NULL,
  `uit_vat2.2` tinyint(1) NOT NULL,
...
INSERT INTO `water` (`ID`, `tijd`, `vat1`, `vat2`, `vat3`, `in_vat1`, `in_vat2`, `uit_vat1.1`, `uit_vat1.2`, `uit_vat2.1`, `uit_vat2.2`, `roerder`) VALUES
