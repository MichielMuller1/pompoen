    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <form action="statusDatabase.php" method="post">
                ...
                <div class="mt-3 statusDiv">
                    ...
                    <p class="d-flex">temperatuur: <span id="temp1" class="statusValue ml-auto"><?= $_SESSION['temperatuur'] ?></span>°C</p>
					<p class="d-flex">luchtvochtigheid: <span id="luchtvochtigheid" class="statusValue ml-auto"><?= $_SESSION['luchtvochtigheid'] ?></span> %</p>
                    <p class="d-flex">grondvochtigheid laag 1: <span id="grondVocht1L1" class="statusValue ml-auto"><?= $_SESSION['grondvochtigheidlaag12'] ?></span></p>
                    <p class="d-flex">grondvochtigheid laag 2: <span id="grondVocht1L2" class="statusValue ml-auto"><?= $_SESSION['grondvochtigheidlaag12'] ?></span></p>
                ...
                <div class="mt-3 statusDiv">
                    ...
                    <p class="d-flex">grondvochtigheid laag 1: <span id="grondVocht2L1" class="statusValue ml-auto"><?= $_SESSION['grondvochtigheidlaag1'] ?></span></p>
                    <p class="d-flex">grondvochtigheid laag 2: <span id="grondVocht2L2" class="statusValue ml-auto"><?= $_SESSION['grondvochtigheidlaag2'] ?></span></p>
                    <div class="form-group d-flex">
