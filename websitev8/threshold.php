...
<!--                    </label>-->
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="tijdvat1" id="tijdvat1" value="<?=$_SESSION['tijdvat1']?>" required>
                    <label for="tijdvat1A">tijdvat1A</label>
                    <input type="number" name="tijdvat1A" id="tijdvat1A" value="<?=$_SESSION['tijdvat1A']?>" required>
...
<!--                    </label>-->
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="tijdvat2" id="tijdvat2" value="<?=$_SESSION['tijdvat2']?>" required>
                    <label for="tijdvat2A">tijdvat2A</label>
                    <input type="number" name="tijdvat2A" id="tijdvat2A" value="<?=$_SESSION['tijdvat2A']?>" required>
...
<!--                    </label>-->
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="tijdvat3" id="tijdvat3" value="<?=$_SESSION['tijdvat3']?>" required>
                    <label for="tijdvat3A">tijdvat3A</label>
                    <input type="number" name="tijdvat3A" id="tijdvat3A" value="<?=$_SESSION['tijdvat3A']?>" required>
                    <label class="switch"> automatisch
